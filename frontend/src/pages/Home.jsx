...
export default function Home() {
    ...
    return (
        ...
        <button className="px-6 py-3 bg-gray-300 rounded-xl shadow hover:bg-gray-400">
          Boulder community
        </button>
        <button className="px-6 py-3 bg-green-500 text-white rounded-xl shadow hover:bg-green-600">
          Games and challenges
        </button>
        <button className="px-6 py-3 bg-orange-500 text-white rounded-xl shadow hover:bg-orange-600">
          Train it!
        </button>
      </div>
    );
